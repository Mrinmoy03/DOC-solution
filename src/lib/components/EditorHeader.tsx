...
export const EditorHeader = ({ fileName, setFileName, onClose, onCloseRequest, onSave, onMenuAction, editor }: EditorHeaderProps) => {
    ...
    return (
        <div className="relative z-30 bg-white px-4 py-1.5 flex items-center justify-between border-b border-gray-200">
                        ...
                        <div className="relative">
                            ...
                            {activeMenu === 'file' && (
                                <DropdownMenu>
                                    ...
                                    <MenuItem onClick={() => handleAction('printPreview')}>Print Preview</MenuItem>
                        ...
                        <div className="relative">
                            ...
                            {activeMenu === 'insert' && (
                                <DropdownMenu>
                                    ...
                                    <MenuItem onClick={() => handleAction('insertShape')}>Shapes</MenuItem>
                                </DropdownMenu>
                            )}
                        </div>
            ...
            <div className="flex items-center gap-2">
                <button
                    onClick={onSave}
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#4285F4] hover:bg-[#3367D6] text-white rounded text-sm font-medium transition-colors"
                >
                    <SaveIcon size={16} />
                    Save
                </button>
                <button
                    onClick={onCloseRequest || onClose}
