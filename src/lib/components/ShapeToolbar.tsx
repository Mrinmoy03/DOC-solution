...
export const ShapeToolbar = ({ onUpdateShape, shapeAttrs, onInsertImage }: ShapeToolbarProps) => {
                    ...
                    <div className="relative">
                        {shapeAttrs.type === 'line' ? (
                            <div className="flex flex-col gap-1 w-full">
                                <button
                                    className="flex items-center gap-2 px-3 py-1.5 hover:bg-gray-100 rounded text-sm w-full"
                                    onClick={() => onUpdateShape({ isEditing: true, editingField: 'text' })}
                                >
                                    <Type size={16} />
                                    Add Text Above
                                </button>
                                <button
                                    className="flex items-center gap-2 px-3 py-1.5 hover:bg-gray-100 rounded text-sm w-full"
                                    onClick={() => onUpdateShape({ isEditing: true, editingField: 'textBelow' })}
                                >
                                    <Type size={16} />
                                    Add Text Below
                                </button>
                            ...
                            <button
                                className="flex items-center gap-2 px-3 py-1.5 hover:bg-gray-100 rounded text-sm w-full"
                                onClick={() => onUpdateShape({ isEditing: true })}
                            >
                                <Type size={16} />
                                Add Text
                            </button>
