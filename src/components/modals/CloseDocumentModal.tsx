...
interface CloseDocumentModalProps {
    onClose: () => void;
    onConfirm: (saveFirst: boolean) => void;
}

export const CloseDocumentModal = ({ onClose, onConfirm }: CloseDocumentModalProps) => {
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={onClose}>
            <div className="bg-white rounded-lg shadow-xl w-[450px]" onClick={(e) => e.stopPropagation()}>
                <div className="flex items-center justify-between p-4 border-b border-gray-200">
                    <h2 className="text-lg font-semibold text-gray-800">Close document</h2>
                    ...
                    <div className="flex items-start gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">
                                Do you want to save the changes to the current document before closing?
                            </p>
                        </div>
                    </div>
